...
const Footer = () => {
    return (
        ...
        <p style={{marginBottom:'0'}} className='text-center text-white'>
            Developed with &hearts; by <a href="https://www.facebook.com/profile.php?id=100010348784252" className="text-decoration-none ps-1 text-white" target="_blank" rel="noreferrer"> Md. Shifat Laskor</a>
        </p>
    </div>
    );
};
